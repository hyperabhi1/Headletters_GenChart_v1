Public Class GenChartService
    ...
    Protected Overrides Sub OnStart(ByVal args() As String)
        ...
        timer.Enabled = True
        Dim strFile As String = String.Format("C:\inetpub\wwwroot\ServiceLogs\ServiceStatusLog_{0}.txt", DateTime.Today.ToString("ddMMMyyyy"))
    ...
    Private Sub TriggerGenChart(obj As Object, e As EventArgs)
        ...
        Catch ex As Exception
            Dim strFile As String = String.Format("C:\inetpub\wwwroot\ServiceLogs\ErrorLog_{0}.txt", DateTime.Today.ToString("ddMMMyyyy"))
