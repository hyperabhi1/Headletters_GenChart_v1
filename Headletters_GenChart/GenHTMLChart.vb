...
Public Class GenHTMLChart
    ...
    Function DashaStringBuilder(ByRef DasaListP As DataTable, ByRef personalDetails As PersonalDetails) As String
        ...
        htmlBuilder.Append(vbCrLf + "        </tr>")
        htmlBuilder.Append(vbCrLf + "        <tr>")
        htmlBuilder.Append(vbCrLf + "            <td style='width:30.35%;'>")
        htmlBuilder.Append(vbCrLf + "                <table width='100%' cellspacing='0' cellpadding='0'>")
        htmlBuilder.Append(vbCrLf + "                    <tr>")
        htmlBuilder.Append(vbCrLf + "                        <td>")
        ...
        Dim OneThird As Integer = DasaListP.Rows.Count * 0.333333
        For i As Integer = 0 To OneThird - 1
            htmlBuilder.Append(vbCrLf + "                                    <tr>")
        ...
        htmlBuilder.Append(vbCrLf + "                                <tbody style='display:block;width: 400px;height: auto;'>")
        htmlBuilder.Append(vbCrLf + "                                    <tr>")
        Dim TwoThird As Integer = DasaListP.Rows.Count * 0.666666
        For i As Integer = OneThird To TwoThird - 1
            htmlBuilder.Append(vbCrLf + "                                        <td style='text-align:center;border-collapse: collapse;padding:5px 3px;color: #33334B;font-family: sans-serif;font-size: 11px;border-right: 1px solid #b7b4b4;width:66px;'>" + DasaListP.Rows(i).ItemArray(0) + "</td>")
            htmlBuilder.Append(vbCrLf + "                                        <td style='text-align:center;border-collapse: collapse;padding:5px 3px;color: #33334B;font-family: sans-serif;font-size: 11px;border-right: 1px solid #b7b4b4;width:66px;'>" + DasaListP.Rows(i).ItemArray(1) + "</td>")
            htmlBuilder.Append(vbCrLf + "                                        <td style='text-align:center;border-collapse: collapse;padding:5px 3px;color: #33334B;font-family: sans-serif;font-size: 11px;border-right: 1px solid #b7b4b4;width:66px;'>" + DasaListP.Rows(i).ItemArray(2) + "</td>")
            htmlBuilder.Append(vbCrLf + "                                        <td style='text-align:center;border-collapse: collapse;padding:5px 3px;color: #33334B;font-family: sans-serif;font-size: 11px;width: 200px;'>" + DasaListP.Rows(i).ItemArray(5) + "</td>")
        ...
        htmlBuilder.Append(vbCrLf + "                                <tbody style='display:block;width: 400px;height:auto;'>")
        htmlBuilder.Append(vbCrLf + "                                    <tr>")
        For i As Integer = TwoThird To DasaListP.Rows.Count - 1
            htmlBuilder.Append(vbCrLf + "                                        <td style='text-align:center;border-collapse: collapse;padding:5px 3px;color: #33334B;font-family: sans-serif;font-size: 11px;border-right: 1px solid #b7b4b4;width:66px;'>" + DasaListP.Rows(i).ItemArray(0) + "</td>")
            htmlBuilder.Append(vbCrLf + "                                        <td style='text-align:center;border-collapse: collapse;padding:5px 3px;color: #33334B;font-family: sans-serif;font-size: 11px;border-right: 1px solid #b7b4b4;width:66px;'>" + DasaListP.Rows(i).ItemArray(1) + "</td>")
            htmlBuilder.Append(vbCrLf + "                                        <td style='text-align:center;border-collapse: collapse;padding:5px 3px;color: #33334B;font-family: sans-serif;font-size: 11px;border-right: 1px solid #b7b4b4;width:66px;'>" + DasaListP.Rows(i).ItemArray(2) + "</td>")
            htmlBuilder.Append(vbCrLf + "                                        <td style='text-align:center;border-collapse: collapse;padding:5px 3px;color: #33334B;font-family: sans-serif;font-size: 11px;width: 200px;'>" + DasaListP.Rows(i).ItemArray(5) + "</td>")
    ...
    Function HTMLStringBuilder(ByRef HIDUIDDateTime As String, ByRef HID As String, ByRef UID As String, ByRef P_List As String(), ByRef H_List As String(), ByRef BirthLagna As String(,), ByRef BirthBhav As String(,), ByRef BirthSouth As String(), ByRef DasaListP As DataTable, ByRef personalDetails As PersonalDetails) As String
        ...
        htmlBuilder.Append(vbCrLf + "                <table width='744' style='border: 1px solid #ddd;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>")
        htmlBuilder.Append(vbCrLf + "                    <tr>")
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(12) <> "", BirthSouth(12).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(12).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(1) <> "", BirthSouth(1).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(1).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(2) <> "", BirthSouth(2).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(2).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(3) <> "", BirthSouth(3).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(3).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        htmlBuilder.Append(vbCrLf + "                    </tr>")
        htmlBuilder.Append(vbCrLf + "                    <tr>")
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(11) <> "", BirthSouth(11).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(11).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        ...
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(4) <> "", BirthSouth(4).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(4).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        htmlBuilder.Append(vbCrLf + "                    </tr>")
        htmlBuilder.Append(vbCrLf + "                    <tr>")
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(10) <> "", BirthSouth(10).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(10).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(5) <> "", BirthSouth(5).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(5).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        htmlBuilder.Append(vbCrLf + "                    </tr>")
        htmlBuilder.Append(vbCrLf + "                    <tr>")
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(9) <> "", BirthSouth(9).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(9).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(8) <> "", BirthSouth(8).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(8).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(7) <> "", BirthSouth(7).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(7).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        htmlBuilder.Append(vbCrLf + "                        <td style='width: 25%;height: 100px;text-align: center;border: 1px solid #ff8c00;border-collapse: collapse;padding: 8px;color: #33334B;font-family: sans-serif;font-size: 14px;'>" + If(BirthSouth(6) <> "", BirthSouth(6).Replace(vbCrLf, "<br>").Substring(0, BirthSouth(6).Replace(vbCrLf, "<br>").Length - 4), "") + "</td>")
        htmlBuilder.Append(vbCrLf + "                    </tr>")
        htmlBuilder.Append(vbCrLf + "                </table>")
        htmlBuilder.Append(vbCrLf + "            </td>")
        htmlBuilder.Append(vbCrLf + "        </tr>")
        ...
        htmlBuilder.Append(vbCrLf + "        <tr>")
        htmlBuilder.Append(vbCrLf + "            <td>")
        htmlBuilder.Append(vbCrLf + "                <h3 class='box-head' style='margin: 0 0 0px;color: #33334B;font-family: sans-serif;font-weight: 600;font-size: 18px;'><a href='http://49.50.103.132/letterhead/templates/" + HIDUIDDateTime + "_Dasha.html'>Dasa listing</a></h3>")
        htmlBuilder.Append(vbCrLf + "            </td>")
        htmlBuilder.Append(vbCrLf + "        </tr>")
        'htmlBuilder.Append(vbCrLf + "        <tr>")
        'htmlBuilder.Append(vbCrLf + "            <td>")
